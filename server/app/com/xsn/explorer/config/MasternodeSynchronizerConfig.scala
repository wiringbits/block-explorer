...
case class MasternodeSynchronizerConfig(
    enabled: Boolean,
...
object MasternodeSynchronizerConfig {
  ...
  def apply(config: Configuration): MasternodeSynchronizerConfig = {
    ...
    val initialDelay: FiniteDuration =
      config.get[FiniteDuration]("masternodeSynchronizer.initialDelay")
    val interval: FiniteDuration =
      config.get[FiniteDuration]("masternodeSynchronizer.interval")
