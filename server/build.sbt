...
libraryDependencies += "io.sentry" % "sentry-logback" % "5.4.2"
...
libraryDependencies += "io.kamon" %% "kamon-bundle" % "2.4.1"
libraryDependencies += "io.kamon" %% "kamon-apm-reporter" % "2.4.1"
