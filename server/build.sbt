...
libraryDependencies += "org.scalactic" %% "scalactic" % "3.2.4"
...
libraryDependencies += "org.mockito" %% "mockito-scala" % "1.16.25" % Test
libraryDependencies += "org.mockito" %% "mockito-scala-scalatest" % "1.16.25" % Test
