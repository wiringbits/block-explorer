...
libraryDependencies += "io.sentry" % "sentry-logback" % "5.2.0"
...
libraryDependencies += "com.sendgrid" % "sendgrid-java" % "4.7.6"

libraryDependencies += "io.kamon" %% "kamon-bundle" % "2.2.3"
libraryDependencies += "io.kamon" %% "kamon-apm-reporter" % "2.2.3"

libraryDependencies += "org.scalatestplus.play" %% "scalatestplus-play" % "5.1.0" % Test
libraryDependencies += "org.mockito" %% "mockito-scala" % "1.16.42" % Test
libraryDependencies += "org.mockito" %% "mockito-scala-scalatest" % "1.16.42" % Test
