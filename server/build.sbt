...
libraryDependencies += "io.sentry" % "sentry-logback" % "5.0.0"
...
libraryDependencies += "io.kamon" %% "kamon-bundle" % "2.1.20"
libraryDependencies += "io.kamon" %% "kamon-apm-reporter" % "2.1.20"
