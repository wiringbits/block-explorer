...
libraryDependencies += "io.sentry" % "sentry-logback" % "4.0.0"
...
libraryDependencies += "io.kamon" %% "kamon-bundle" % "2.1.10"
libraryDependencies += "io.kamon" %% "kamon-apm-reporter" % "2.1.10"

libraryDependencies += "org.scalatestplus.play" %% "scalatestplus-play" % "5.1.0" % Test
libraryDependencies += "org.mockito" %% "mockito-scala" % "1.16.19" % Test
libraryDependencies += "org.mockito" %% "mockito-scala-scalatest" % "1.16.19" % Test
