...
libraryDependencies += "org.postgresql" % "postgresql" % "42.2.21"
...
libraryDependencies += "io.kamon" %% "kamon-bundle" % "2.2.0"
libraryDependencies += "io.kamon" %% "kamon-apm-reporter" % "2.2.0"
